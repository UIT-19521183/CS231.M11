...
X1 = pd.read_csv('X_HL_train.csv')
y1 = pd.read_csv('y_HL_train.csv')
...
joblib.dump(clf1, 'pedestrian_HL.pkl')

X1_hard = pd.read_csv('X_HL_train_hard.csv')
y1_hard = pd.read_csv('y_HL_train_hard.csv')
...
joblib.dump(clf2, 'pedestrian_final_hard_HL.pkl')
print('Training done')
