...
parser.add_argument('--path', help="Path to file containing model's weights")
parser.add_argument('--detect', help='Path to directory contraining detect images')
...
scale = 0
model = joblib.load('/content/pedestrian_final_hard.pkl')
