...
parser.add_option("--output_weight_path", dest="output_weight_path", help="Output path for weights.", default='/content/drive/MyDrive/ComputerVision(CS231.M11)/Faster R-CNN/model3/trained_model.hdf5')
